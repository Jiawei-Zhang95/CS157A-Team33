          ...
          <MDBCol md="9" lg="7" xl="5" className="mx-auto mt-3" >
            <MDBCard style = {{ marginTop: '25%'}} >
              <MDBCardBody className="mx-4" >
                ...
                <MDBBtn type="button" gradient="blue" rounded className="btn blue-gradient btn-block btn-rounded z-depth-1a waves-effect waves-light" onClick={this.login}>Log in</MDBBtn>
                </div>
              </MDBCardBody>
              <MDBModalFooter className="mx-5 pt-3 mb-1">
                <div className="grey-text d-flex justify-content-end" style={{ fontSize:'0.8rem'}}>Not a member? <Link to="/signup" className="blue-text ml-1"> Sign Up</Link></div>
              </MDBModalFooter>
            </MDBCard>
          </MDBCol>
        </MDBRow>
